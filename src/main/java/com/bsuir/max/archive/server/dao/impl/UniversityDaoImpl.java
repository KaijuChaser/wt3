package com.bsuir.max.archive.server.dao.impl;

import com.bsuir.max.archive.server.bean.Student;
import com.bsuir.max.archive.server.dao.DaoException;
import com.bsuir.max.archive.server.dao.UniversityDao;
import com.bsuir.max.archive.server.dao.parser.XMLParser;
import com.bsuir.max.archive.server.dao.parser.XMLParserException;
import com.bsuir.max.archive.server.dao.parser.impl.XMLUniversityParser;
import com.bsuir.max.archive.server.dao.writer.Writer;
import com.bsuir.max.archive.server.dao.writer.XMLWriterException;
import com.bsuir.max.archive.server.dao.writer.impl.WriterImpl;
